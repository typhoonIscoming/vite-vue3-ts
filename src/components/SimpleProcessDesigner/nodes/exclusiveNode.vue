	...
	<div class="branch-node-wrapper">
		<div class="branch-node-container">
			...
			>
				...
				<div class="node-wrapper bg-white relative">
					<div class="w-200px">
						<div class="relative node-root">
							<div
								class="node-box overflow-hidden"
								:class="[
									{ 'node-config-error': !item.showText },
									`${useTaskStatusClass(item.activityStatus)}`
								]"
							>
								<div class="branch-node-title-container flex justify-between">
...
import ProcessNodeTree from '../simpleProcessNode.vue'
import { SimpleFlowNode, NodeType, NODE_DEFAULT_TEXT } from '../config/consts'
import { getDefaultConditionNodeName } from '../config/utils'
import { useTaskStatusClass } from '../config/nodes'
